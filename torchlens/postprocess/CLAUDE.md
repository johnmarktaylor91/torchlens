...
|------|-------|--------|---------|
| `__init__.py` | orchestrator | 158 | Dispatches to submodules, fast-mode postprocess |
| `graph_traversal.py` | 1-4 | 352 | Output layers, ancestor marking, orphan removal, distance flood |
| `control_flow.py` | 5-7 | 265 | Conditional branches, module fixing, buffer cleanup |
| `loop_detection.py` | 8 | 558 | Isomorphic subgraph expansion, loop detection, layer assignment |
| `labeling.py` | 9-12 | 510 | Label generation, rename, trim/reorder, lookup keys |
| `finalization.py` | 13-18 | 478 | Undecorate, ParamLog, ModuleLog, LayerLog, mark complete |
...
| 5 | `_mark_conditional_branches` | Find terminal booleans → backtrack to branch points |
